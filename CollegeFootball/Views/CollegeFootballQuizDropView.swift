...
// This flow is a college football adaptation of the production Takes World Cup quiz
...
private enum CollegeFootballDailyQuizPhase: Equatable {
    case landing
    case stories
    case quiz
    case reward(CollegeFootballQuizResult)
}

struct CollegeFootballQuizResult: Equatable {
    let correct: Int
    let total: Int
    let seconds: Int
    let points: Int
...
struct CollegeFootballDailyDropDiscoveryCardContent: View {
    let drop: CollegeFootballDailyDrop
    let isCollected: Bool

    var body: some View {
        ZStack(alignment: .topLeading) {
            CollegeFootballRemoteImage(
            ...
            LinearGradient(
                colors: [
                    .black.opacity(0.20),
                    .black.opacity(0.34),
                    CollegeFootballQuizPalette.background.opacity(0.98),
                ],
                startPoint: .top,
                endPoint: .bottom
            )
            ...
            VStack(alignment: .leading, spacing: 8) {
                HStack(alignment: .center, spacing: 7) {
                    ...
                    Text(isCollected ? "COLLECTED" : "BRAND NEW")
                        ...
                        .background(
                            isCollected
                                ? CollegeFootballQuizPalette.correct
                                : Color.yellow,
                            in: Capsule()
                        )
                }
...
struct CollegeFootballDailyDropFullScreenView: View {
    let drop: CollegeFootballDailyDrop
    let onCollect: (CollegeFootballSticker) -> Void
    let onOpenCollection: () -> Void
    let onDismiss: () -> Void

    @State private var phase: CollegeFootballDailyQuizPhase = .landing

    var body: some View {
        ZStack {
            CollegeFootballQuizPalette.background
                .ignoresSafeArea()

            switch phase {
            case .landing:
                CollegeFootballQuizLandingView(
                    drop: drop,
                    onClose: onDismiss,
                    onStart: {
                        CollegeFootballQuizHaptics.affirm()
                        phase = .stories
                    }
                )
                .transition(.opacity)
            ...
            case .stories:
                CollegeFootballQuizStoriesView(
            ...
            case .quiz:
                CollegeFootballQuizQuestionsView(
...
private enum CollegeFootballQuizPalette {
    ...
    static func accent(for sticker: CollegeFootballSticker) -> SwiftUI.Color {
        if sticker.teamName == "Colorado Buffaloes" {
            return BuffsTheme.brightGold
        }
        return auraCore
    }
    ...
    static func accentLight(
        ...
        if sticker.teamName == "Colorado Buffaloes" {
            return Color(red: 1, green: 0.88, blue: 0.48)
        }
        return auraLight
    }
}
...
@MainActor
private enum CollegeFootballQuizHaptics {
    static func tap() {
...
private struct CollegeFootballQuizCloseButton: View {
...
private struct CollegeFootballQuizLandingView: View {
    let drop: CollegeFootballDailyDrop
    let onClose: () -> Void
    let onStart: () -> Void
        ...
        ZStack {
            ...
            LinearGradient(
                colors: [
                    .black.opacity(0.54),
                    .black.opacity(0.10),
                    CollegeFootballQuizPalette.background.opacity(0.96),
                ],
                startPoint: .top,
                endPoint: .bottom
            )
            ...
            VStack(alignment: .leading, spacing: 0) {
                HStack {
                    CollegeFootballQuizCloseButton(
                        quizTitle: drop.title,
                        action: onClose
                    )
                    Spacer()
                ...
                VStack(alignment: .leading, spacing: 16) {
                        ...
                        .background(
                            Capsule()
                                .fill(
                                    LinearGradient(
                                        colors: [
                                            CollegeFootballQuizPalette.accent(
                                                for: drop.rewardSticker
                                            ),
                                            CollegeFootballQuizPalette.accentLight(
                                                for: drop.rewardSticker
                                            ),
                                        ],
                                        startPoint: .leading,
                    ...
                    .buttonStyle(CollegeFootballPressableScaleStyle())
...
private struct CollegeFootballQuizStoriesView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            CollegeFootballRemoteImage(
                ...
                fallbackSystemImage: "football.fill"
            )
            .ignoresSafeArea()
            .id(index)
            .transition(.opacity)
    ...
    private var currentStory: CollegeFootballQuizStory? {
        guard stories.indices.contains(index) else { return nil }
        return stories[index]
    }

    private func goForward() {
        CollegeFootballQuizHaptics.tap()
...
private struct CollegeFootballQuizQuestionsView: View {
    let questions: [CollegeFootballQuizQuestion]
    let quizTitle: String
    let onClose: () -> Void
    let onComplete: (CollegeFootballQuizResult) -> Void
        ...
        ZStack(alignment: .topLeading) {
            ...
            VStack(spacing: 16) {
                ...
                if let question = currentQuestion {
                    CollegeFootballTriviaQuestionView(
                        question: question,
            ...
            if isCelebrating {
                CollegeFootballCommishCelebrationView {
                    isCelebrating = false
                }
                .id(celebrationID)
            }
    ...
    private var currentQuestion: CollegeFootballQuizQuestion? {
    ...
    private func progressColor(for index: Int) -> LinearGradient {
        let pending = LinearGradient(
            colors: [
                CollegeFootballQuizPalette.auraLight,
                CollegeFootballQuizPalette.auraCore,
            ],
            startPoint: .leading,
            endPoint: .trailing
        )
        ...
        let color = wasCorrect
            ? CollegeFootballQuizPalette.correct
            : CollegeFootballQuizPalette.wrong
    ...
    private func answer(_ answerIndex: Int) {
        ...
        if answerIndex == question.correctAnswerIndex {
            ...
            CollegeFootballQuizHaptics.reject()
        }
...
private struct CollegeFootballTriviaQuestionView: View {
    let question: CollegeFootballQuizQuestion
    ...
    private func answerBackground(index: Int) -> SwiftUI.Color {
        ...
        if index == question.correctAnswerIndex {
            return CollegeFootballQuizPalette.correct.opacity(0.18)
        }
        if index == selectedAnswerIndex {
            return CollegeFootballQuizPalette.wrong.opacity(0.18)
        }
    ...
    private func answerStroke(index: Int) -> SwiftUI.Color {
        ...
        if index == question.correctAnswerIndex {
            return CollegeFootballQuizPalette.correct
        }
        if index == selectedAnswerIndex {
            return CollegeFootballQuizPalette.wrong
        }
        return .white.opacity(0.12)
    }
}

private struct CollegeFootballPressableScaleStyle: ButtonStyle {
...
private struct CollegeFootballRemoteImage: View {
...
private final class CollegeFootballCommishCelebrationViewModel: RiveViewModel {
    var onFinished: (() -> Void)?
...
private struct CollegeFootballCommishCelebrationView: View {
    let onFinished: () -> Void

    @StateObject private var rive = CollegeFootballCommishCelebrationViewModel()
...
private final class CollegeFootballPackRipViewModel: RiveViewModel {
    var onFinished: (() -> Void)?
    private var didFinish = false
...
private struct CollegeFootballPackRipView: View {
    let onOpen: () -> Void
    let onReveal: () -> Void

    @StateObject private var rive = CollegeFootballPackRipViewModel()
...
private struct CollegeFootballQuizRewardView: View {
    let sticker: CollegeFootballSticker
    let result: CollegeFootballQuizResult
    let onClaim: () -> Void
    ...
    private var flippableCard: some View {
        ZStack {
            CollegeFootballStickerCardView(sticker: sticker, size: .large)
                .opacity(isFlipped ? 0 : 1)

            CollegeFootballStickerBackView(sticker: sticker)
                .rotation3DEffect(
                    .degrees(180),
                    axis: (x: 0, y: 1, z: 0)
                )
...
enum CollegeFootballStickerCardSize {
    case compact
    case large
...
struct CollegeFootballStickerCardView: View {
    let sticker: CollegeFootballSticker
    let size: CollegeFootballStickerCardSize
    ...
    private var accent: SwiftUI.Color {
        CollegeFootballQuizPalette.accent(for: sticker)
    }

    private var accentLight: SwiftUI.Color {
        CollegeFootballQuizPalette.accentLight(for: sticker)
    }
...
private struct CollegeFootballStickerBackView: View {
    let sticker: CollegeFootballSticker
