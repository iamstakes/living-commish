...
struct AnimatedHostDescriptor: Equatable, Identifiable, Sendable {
    ...
    static let commish = AnimatedHostDescriptor(
        ...
        accessibilityName: "Living Commish animated college football guide",
        personaInstructions: """
        A fictional animated league host with dry wit, emotional range, and excellent timing.
        The host explains supplied college football context without inventing facts or speaking for a real person.
        """,
